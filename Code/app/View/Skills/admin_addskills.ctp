...
$this->Html->addCrumb('<i class="fa fa-plus" ></i> Add Skill');
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <!-- Bread crumb end -->
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Add Skills </h4>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Skills Name<div class="required_field">*</div></label>
                            <div class="col-sm-10" >
