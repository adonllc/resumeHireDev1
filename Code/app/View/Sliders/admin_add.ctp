...
$this->Html->addCrumb('<i class="fa fa-plus"></i> Add Slider', 'javascript:void(0)', array('escape' => false));
?>
<?php echo $this->Form->create('Slider', array('method' => 'POST', 'name' => 'addBlog', 'enctype' => 'multipart/form-data', 'id' => 'addBlog')); ?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Add Slider</h4>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Slider Image <div class="required_field">*</div></label>
                            <div class="col-sm-10">
                                <div id="fileupload" class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <span >Supported File Types: gif, jpg, jpeg, png (Max. <?php echo $max_size; ?>MB). Best file size 1920 X 1084 pixels. </span>
                                </div>
                            </div>
                        </div>
