...
$this->Html->addCrumb('<i class="fa fa-list"></i> Add Sub Category', 'javascript:void(0)', array('escape' => false));
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <!-- Bread crumb end -->
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Add Sub Category</h4>
