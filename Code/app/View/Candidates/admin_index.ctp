...
$this->Html->addCrumb('<i class="fa fa-list"></i> Jobseeker List', 'javascript:void(0)', array('escape' => false));
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        ...
        <div class="row">
                    ...
                    <header class="panel-heading">
                        ...
                        if(ClassRegistry::init('Admin')->getCheckRolesSub($adminLId, $checkSubRols, 2, 1)){ ?>
                            <span class="exportlink btn btn-success btn-xs pull-right">
                                <?php echo $this->Html->link('<i class="" aria-hidden="true"></i> Add Jobseeker ', array('controller' => 'candidates', 'action' => 'addcandidates'), array('escape' => false, 'title' => 'Add Jobseeker')); ?>
                            </span>
                        <?php } ?>
                    </header>
                    <div class="row-fluid ">
                        ...
                        <div class="panel-body">
                            ...
                            <p>Search Jobseeker by typing name, email or Created date</p>
                            ...
                            <?php echo $this->Ajax->submit("Search", array('div' => false, 'url' => array('controller' => 'candidates', 'action' => 'index'), 'update' => 'listID', 'indicator' => 'loaderID', 'class' => 'btn btn-success')); ?>
                            <?php echo $this->Html->link('Clear Filter', array('controller' => 'candidates', 'action' => 'index'), array('escape' => false, 'class' => 'btn btn-default')); ?>
            ...
            <!-- element start-->
            <div id="listID">
                <?php echo $this->element("admin/candidates/index"); ?>
            </div>
            <!-- element end-->
