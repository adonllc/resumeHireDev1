...
<?php echo $this->Form->create('null', array('url' => array('controller' => 'candidates', 'action' => 'sendmailemployer', $mailDetail['Company']['slug']), 'enctype' => 'multipart/form-data', "method" => "Post", "id" => 'sendmail')); ?>
