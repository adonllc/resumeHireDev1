...
$this->Html->addCrumb('<i class="fa fa-pencil"></i> Edit Sub Admin', 'javascript:void(0)', array('escape' => false));
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Edit Sub Admin</h4>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <?php echo $this->Form->password('Admin.new_password', array('minlength' => '8', 'maxlength' => '40', 'size' => '25', 'label' => '', 'id' => 'password', 'div' => false, 'class' => "form-control pass", 'autocomplete' => 'off')) ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Confirm Password <div class="required_field"></div></label>
                            <div class="col-sm-10" >
                                <?php echo $this->Form->password('Admin.confirm_password', array('maxlength' => '255', 'size' => '25', 'label' => '', 'equalTo' => '#password', 'div' => false, 'class' => "form-control")) ?>
                            </div>
                        </div>
                    </div>
                </section>
        ...
        <div class="col-lg-9">
            ...
            <?php
                ...
                echo $this->Form->hidden('Admin.old_username');
                echo $this->Form->hidden('Admin.old_email');
                echo $this->Form->hidden('Admin.old_password');
                ?>
