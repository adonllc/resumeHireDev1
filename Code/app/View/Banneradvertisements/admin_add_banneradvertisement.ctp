...
$this->Html->addCrumb('<i class="fa fa-plus"></i> Add Banner Advertisement', 'javascript:void(0)', array('escape' => false));
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Add Advertisement</h4>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <?php global $advertisementPlace; ?>
                                <?php echo $this->Form->input('Banneradvertisement.advertisement_place', array('type' => 'select', 'options' => $advertisementPlace, 'label' => false, 'div' => false, 'class' => "form-control required", 'empty' => 'Select Place of Advertisement', 'id' => 'discount_type', 'onchange' => 'cahangeDiscountType();')) ?>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" id = "advertisementimage2" <?php if ($type == 2 || $type == 3) { ?>style="display:none;" <?php } ?>>
                            <label class="col-sm-2 col-sm-2 control-label">Advertisement Image <div class="required_field">*</div> </label>
                            <div class="col-sm-10">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    ...
                                    <div>
                                        <span class="btn btn-white btn-file">
                                            ...
                                            <?php echo $this->Form->input('Banneradvertisement.image', array('type' => 'file', 'label' => false, 'div' => false, 'class' => 'default required', 'id' => 'upload_image', 'onchange' => 'return  imageValidation();')) ?>
                                        </span>
                                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="col-lg-9">
                    ...
                    <?php echo $this->Html->link('Reset', array('controller' => 'banneradvertisements', 'action' => 'addBanneradvertisement'), array('escape' => false, 'class' => 'btn btn-danger')); ?>
                </div></div></div>
    </section>
</section>
