...
$this->Html->addCrumb('<i class="fa fa-plus" ></i> Add Locations');
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <!-- Bread crumb end -->
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Add Locations </h4>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Locations Name<div class="required_field">*</div></label>
                            <div class="col-sm-10" >
