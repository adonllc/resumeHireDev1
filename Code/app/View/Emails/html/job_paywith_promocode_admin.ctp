...
<tr>
    <td style="color:#434343; font-size:13px; line-height:18px;">
        <p style="color:#434343; margin:10px 0 0;"><?php echo $username;?> has successfully posted job:  <b><?php echo $jobTitle;?></b> and selected Pay with Promocode option for payment.</p>
        ...
        <p style="color:#434343; margin:0px 0 0;"><strong style="width:150px;">Promo Code:</strong> <?php echo $promocode;?></p>   
