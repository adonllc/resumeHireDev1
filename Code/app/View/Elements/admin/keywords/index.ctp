    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <?php
            $urlArray = array_merge(array('controller' => 'keywords', 'action' => 'index',$separator));
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="Action">
                                           ...
                                           <span id="status<?php echo $announcement['Keyword']['id']; ?>">
                                            ...
                                            <?php echo $this->Html->link('<i class="fa fa-trash-o "></i>', array('controller' => 'keywords', 'action' => 'delete',$announcement['Keyword']['slug']), array('update' => 'deleted' . $announcement['Keyword']['id'], 'indicator' => 'loaderID', 'class' => 'btn btn-primary btn-xs', 'confirm' => 'Are you sure you want to Delete ?', 'escape' => false, 'title' => 'Delete')); ?>
            ...
            <div id="actdiv" class="outside">
                <div class="block-footer mogi">
                    ...
                    <?php echo $this->Ajax->submit("Activate", array('div' => false, 'url' => array('controller' => 'keywords', 'action' => 'index'), 'update' => 'listID', 'indicator' => 'loaderID', 'before' => "setAction('activate');", 'confirm' => "Are you sure you want to Activate ?", 'condition' => "isAnySelect(this.form)", "complete" => "showMessage('activated');", 'class' => 'btn btn-success btn-cons')); 
                        echo $this->Ajax->submit("Deactivate", array('div' => false, 'url' => array('controller' => 'keywords', 'action' => 'index'), 'update' => 'listID', 'indicator' => 'loaderID', 'before' => "setAction('deactivate');", 'confirm' => "Are you sure you want to Deactivate ?", 'condition' => "isAnySelect(this.form)", "complete" => "showMessage('deactivated');", 'class' => 'btn btn-success btn-cons')); 
                     echo $this->Ajax->submit("Delete", array('div' => false, 'url' => array('controller' => 'keywords', 'action' => 'index'), 'update' => 'listID', 'indicator' => 'loaderID', 'before' => "setAction('delete');", 'confirm' => "Are you sure you want to Delete ?", 'condition' => "isAnySelect(this.form)", "complete" => "showMessage('deleted');", 'class' => 'btn btn-success btn-cons')); ?> 
                </div>
            </div>
            <div id="pagingLinks" align="right">
                    <?php __("Showing Page"); ?>
