                        ...
                        <table class="table table-bordered table-striped table-condensed cf">
                            <thead class="cf">
                                <tr>
                                    ...
                                    <!-- <th class="sorting_paging"><?php //echo $this->Paginator->sort('User.abn', 'ABN');  ?></th>-->
                                    <th class="sorting_paging"><?php echo $this->Paginator->sort('User.first_name', 'Full Name'); ?></th>
                                    <th class="sorting_paging"><?php echo $this->Paginator->sort('User.position', 'Position'); ?></th>
                                    <th class="sorting_paging"><?php echo $this->Paginator->sort('User.email_address', 'Email'); ?></th>
                                    <th class="sorting_paging">Current Plan</th>
                            ...
                            <tbody>
                                ...
                                foreach ($users as $user) {
                                    ...
                                    <tr>
                                        ...
                                        <!--<td data-title="Employer name"><?php //echo $user['User']['abn'] ? $user['User']['abn'] : 'N/A';  ?></td>-->
                                        ...
                                        <td data-title="Designation"><?php echo $user['User']['position'] ? $user['User']['position'] : 'N/A'; ?></td>
                                        <td data-title="Email"><?php echo $user['User']['email_address']; ?></td>
                                        <td data-title="Plan Name">
                                            <?php 
                                            $myPlan = Classregistry::init('Plan')->getcurrentplanEXP($user['User']['id']);
                                            if($myPlan){
                                                echo $myPlan['Plan']['plan_name'];
...
//                                                }
                                        ...
                                        <td data-title="Action">
                                            <?php if(ClassRegistry::init('Admin')->getCheckRolesSub($adminLId, $checkSubRols, 1, 2)){ ?>
                                            ...
                                            if(ClassRegistry::init('Admin')->getCheckRolesSub($adminLId, $checkSubRols, 1, 3)){
                                                echo $this->Html->link('<i class="fa fa-trash-o "></i>', array('controller' => 'users', 'action' => 'deleteusers', $user['User']['slug']), array('update' => 'deleted' . $user['User']['id'], 'indicator' => 'loaderID', 'class' => 'btn btn-primary btn-xs', 'confirm' => 'Are you sure you want to Delete ?', 'escape' => false, 'title' => 'Delete')); ?>
                                            <?php 
                                            }
                                            if ($user['User']['verify'] == '0') {
                                            echo $this->Html->link($this->Html->image('front/verified_red.png'), array('controller' => 'users', 'action' => 'verifyNow', $user['User']['slug']), array('update' => 'deleted' . $user['User']['id'], 'indicator' => 'loaderID', 'class' => 'nobtn', 'confirm' => 'Are you sure you want to make this employer verified ?', 'escape' => false, 'title' => 'Verify Now')); 
                                            }
                                            ?>
            ...
            <div id="actdiv" class="outside">
                <div class="block-footer mogi">
                    ...
                    <?php 
                    if(ClassRegistry::init('Admin')->getCheckRolesSub($adminLId, $checkSubRols, 1, 2)){
                        echo $this->Ajax->submit("Activate", array('div' => false, 'url' => array('controller' => 'users', 'action' => 'index'), 'update' => 'listID', 'indicator' => 'loaderID', 'before' => "setAction('activate');", 'confirm' => "Are you sure you want to Activate ?", 'condition' => "isAnySelect(this.form)", "complete" => "showMessage('activated');", 'class' => 'btn btn-success btn-cons')); 
                        echo $this->Ajax->submit("Deactivate", array('div' => false, 'url' => array('controller' => 'users', 'action' => 'index'), 'update' => 'listID', 'indicator' => 'loaderID', 'before' => "setAction('deactivate');", 'confirm' => "Are you sure you want to Deactivate ?", 'condition' => "isAnySelect(this.form)", "complete" => "showMessage('deactivated');", 'class' => 'btn btn-success btn-cons')); 
                    }
                   
                    if(ClassRegistry::init('Admin')->getCheckRolesSub($adminLId, $checkSubRols, 1, 3)){
                        echo $this->Ajax->submit("Delete", array('div' => false, 'url' => array('controller' => 'users', 'action' => 'index'), 'update' => 'listID', 'indicator' => 'loaderID', 'before' => "setAction('delete');", 'confirm' => "Are you sure you want to Delete ?", 'condition' => "isAnySelect(this.form)", "complete" => "showMessage('deleted');", 'class' => 'btn btn-success btn-cons'));
                    }?> 
