...
<!--                     <li>
                    ...
                    <li>
                        <?php echo $this->Html->link('<i class="fa fa-crosshairs" aria-hidden="true"></i> <span> Change Color Theme</span>', array('controller' => 'admins', 'action' => 'changecolorscheme'), array('class' => $changecolorscheme, 'escape' => false)); ?>
                    </li>
                    <li>
                ...
                <ul class="sub" <?php echo $jobs_active; ?>>
                    ...
                    <li>
                     ...
                     <li>
                        <?php 
                        if(ClassRegistry::init('Admin')->getCheckRolesSub($adminLId, $checkSubRols, 2, 1)){ 
                            echo $this->Html->link('<i class="fa fa-file"></i><span> Import Job</span>', array('controller' => 'jobs', 'action' => 'import'), array('class' => $import_job, 'escape' => false));
                        } ?>
                    </li>
                     <li>
                        <?php 
                        if(ClassRegistry::init('Admin')->getCheckRolesSub($adminLId, $checkSubRols, 2, 1)){ 
                            echo $this->Html->link('<i class="fa fa-file"></i><span> Auto Job Import List</span>', array('controller' => 'jobs', 'action' => 'importlist'), array('class' => $import_list, 'escape' => false));
                        } ?>
                    </li>
