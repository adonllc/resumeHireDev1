<script type="text/javascript">
    ...
    function fblogin() {
        ...
        newwindow = window.open('<?php echo HTTP_PATH; ?>/app/webroot/facebook/fbconfig.php', 'Signup by facebook', features);
...
//        }
    ...
    function connect_with_linkedin() {
        ...
        //var userType = getCheckedRadioValue('employer');
