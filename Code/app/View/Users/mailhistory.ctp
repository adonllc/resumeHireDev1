...
function isAllSelect(frmObject){
    ...
    function getMailList() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo HTTP_PATH . '/users/mailhistory' ; ?>",
            cache: false,
            ...
            <div class="my_acc">
                ...
                <div class="col-sm-9 col-lg-9 col-xs-12">
                    <div class="my-profile-boxes">
                        <div class="my-profile-boxes-top my-payments-boxes"><h2><i><?php echo $this->Html->image('front/home/mailhistory-icon2.png', array('alt' => '')); ?></i><span><?php echo __d('user', 'Mail History', true); ?></span></h2>
                        </div>
...
<!--                                <div class="tabs"> 
                                ...
                                <div class="job_scroll">
                                    ...
                                    <div id='listID'>
                                        ...
                                        <?php echo $this->element('users/mail'); ?>    
