...
*/
	...
	var $oauth_user_agent = 'PHP-OAuth-API (https://www.phpclasses.org/oauth-api $Revision: 1.74 $)';
...
*/
	Function Initialize()
	{
		...
		switch($this->server)
		{
			...
			case 'Eventful':
				$this->oauth_version = '1.0a';
				$this->request_token_url = 'https://eventful.com/oauth/request_token';
				$this->dialog_url = 'https://eventful.com/oauth/authorize';
				$this->access_token_url = 'https://eventful.com/oauth/access_token';
				$this->authorization_header = false;
			...
			case 'Fitbit':
				$this->oauth_version = '1.0a';
				$this->request_token_url = 'https://api.fitbit.com/oauth/request_token';
				$this->dialog_url = 'https://api.fitbit.com/oauth/authorize';
				$this->access_token_url = 'https://api.fitbit.com/oauth/access_token';
				break;

			case 'Flickr':
				$this->oauth_version = '1.0a';
				$this->request_token_url = 'https://www.flickr.com/services/oauth/request_token';
				$this->dialog_url = 'https://www.flickr.com/services/oauth/authorize?perms={SCOPE}';
				$this->access_token_url = 'https://www.flickr.com/services/oauth/access_token';
				$this->authorization_header = false;
				break;
			...
			case 'Tumblr':
				$this->oauth_version = '1.0a';
				$this->request_token_url = 'https://www.tumblr.com/oauth/request_token';
				$this->dialog_url = 'https://www.tumblr.com/oauth/authorize';
				$this->access_token_url = 'https://www.tumblr.com/oauth/access_token';
				break;
