...
$this->Html->addCrumb('<i class="fa fa-list"></i> Add Newsletter', 'javascript:void(0)', array('escape' => false));
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <!-- Bread crumb end -->
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Add Newsletters </h4>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10" >
                                <?php echo $this->Fck->fckeditor(array('Newsletter', 'message'), $this->Html->base); ?>
                            </div>
                        </div>
                    </div>
                </section>
