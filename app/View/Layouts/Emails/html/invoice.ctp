...
$payment_enquiry_mail = $this->requestAction(array('controller' => 'App', 'action' => 'getMailConstant', 'payment_enquiry_mail'));
//pr($data); die;
...
<!--                                    <img alt="<?php echo $site_title; ?>" src="<?php echo HTTP_PATH; ?>/app/webroot/img/logo_email.png"/>-->
