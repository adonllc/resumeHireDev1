...
$this->Html->addCrumb('<i class="fa fa-pencil-square-o" ></i> Edit Designation');
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <!-- Bread crumb end -->
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Edit Designation</h4>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Designation Name <div class="required_field">*</div></label>
                            <div class="col-sm-10" >
        ...
        <div class="col-lg-10">
          ...
          //   echo $this->Form->hidden('Skill.old_c_word');
            ...
            <?php echo $this->Html->link('Cancel', array('controller' => 'designations', 'action' => 'index'), array('escape' => false, 'class' => 'btn btn-danger')); ?>        </div>
    </section>
</section>
