...
$this->Html->addCrumb('<i class="fa fa-list"></i> Edit City', 'javascript:void(0)', array('escape' => false));
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <!-- Bread crumb end -->
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Edit City</h4>
        ...
        <div class="col-lg-10">
            ...
            echo $this->Form->hidden('City.slug');
            echo $this->Form->hidden('City.old_name');
            ?>
            <?php echo $this->Form->submit('Save', array('size' => '30', 'label' => '', 'div' => false, 'class' => 'btn btn-success')); ?>
            <?php echo $this->Html->link('Cancel', array('controller' => 'cities', 'action' => 'index',$sslug,$cslug), array('escape' => false, 'class' => 'btn btn-danger')); ?>        </div>
    </section>
</section>
