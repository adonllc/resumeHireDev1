...
<?php
$this->Html->addCrumb('<i class="fa fa-dashboard" ></i> Dashboard » ', array('controller' => 'announcements', 'action' => 'dashboard'), array('escape' => false));
$this->Html->addCrumb('<i class="fa fa-bullhorn" ></i> Announcement List » ', '/admin/announcements', array('escape' => false));
$this->Html->addCrumb('<i class="fa fa-plus" ></i> Add Announcements');
?>
...
<section id="main-content" class="site-min-height">
    <section class="wrapper">
        <div class="row">
            ...
            <!-- Bread crumb end -->
            <div class="col-lg-12">
                <h4 style="margin-left:15px" class="m-bot15">Add Announcement </h4>
