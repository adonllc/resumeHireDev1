...
$jobType = ucfirst($job_data['Job']['type']);

$amount = number_format($job_data['Job']['amount'],2);
if (isset($job_data['Job']['dis_amount']) && $job_data['Job']['dis_amount'] != '') {
    $amount = $job_data['Job']['amount'] - $job_data['Job']['dis_amount'];
}
...
$jobTitle = $job_data['Job']['title'];

$logopath = DISPLAY_FULL_INVOICE_IMAGE_PATH.$adminInfo['Admin']['logo'];
                            ...
                            <td cellpadding="0" colspan="4">
                                <table style="width:85%;" cellspacing="0" >
                                    <tr>
                                        ...
                                        <td style="border-bottom:1px #ddd solid; text-align: center; font-size:10px; font-weight: bold">Amount AUD</td>
                                    </tr> 
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width:40%; font-size:10px;  border-bottom:1px #ddd solid;">JobSiteScript- '.$jobType.' Job Posting <br> '.$jobTitle.'</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:10px; margin-top: 10px;   border-bottom:1px #ddd solid; text-align: center;">Subtotal<br>Total GST 10%<br><b>Total AUD</b></td>
