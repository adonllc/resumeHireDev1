<?php if ($candidates) { ?>
    <div class="sadasd"> Peoples having starting alphabetically - <?php echo $alpha ?> </div>
            ...
            <div class="newc">
                ...
                foreach ($candidates as $candidate) {
                    ...
                    <div class="sadnasdugsadyyyyy">
                        ...
                        <div class="Ytt sadsd">
                            <?php echo $this->Html->link(ucfirst($candidate['User']['first_name']) . ' ' . ucfirst($candidate['User']['last_name']), array('controller' => 'candidates', 'action' => 'publicprofile','slug' => $candidate['User']['slug']), array()); ?>
                        </div>  
