    ...
    <div class="col-lg-12">
        <section class="panel">
            ...
            <?php
            $urlArray = array_merge(array('controller' => 'keywords', 'action' => 'jobs',$separator));
            $this->Paginator->_ajaxHelperClass = "Ajax";
            $this->Paginator->Ajax = $this->Ajax;
            $this->Paginator->options(array('update' => 'listID', 'url' => $urlArray, 'indicator' => 'loaderID'));
            ?>
            <?php echo $this->Form->create("Keyword", array("url" => "jobs", "method" => "Post")); ?>
                                ...
                                <?php foreach ($keywords as $announcement) { ?>
                                    <tr>
                                        ...
                                        <td data-title="Action">
                                           ...
                                           <span id="status<?php echo $announcement['Keyword']['id']; ?>">
                                                <?php
                                                if ($announcement['Keyword']['status'] == '1') {
                                                    echo $this->Ajax->link('<button class="btn btn-success btn-xs"><i class="fa fa-check"></i></button>', array('controller' => 'keywords', 'action' => 'deactivatejobs', $announcement['Keyword']['slug']), array('update' => 'status' . $announcement['Keyword']['id'], 'indicator' => 'loaderIDAct' . $announcement['Keyword']['id'], 'confirm' => 'Are you sure you want to Deactivate ?', 'escape' => false, 'title' => 'Deactivate'));
                                                } else {
                                                    echo $this->Ajax->link('<button class="btn btn-danger btn-xs"><i class="fa fa-ban"></i></button>', array('controller' => 'keywords', 'action' => 'activatejobs', $announcement['Keyword']['slug']), array('update' => 'status' . $announcement['Keyword']['id'], 'indicator' => 'loaderIDAct' . $announcement['Keyword']['id'], 'confirm' => 'Are you sure you want to Activate ?', 'escape' => false, 'title' => 'Activate'));
                                                }
                                                ?>
                                            </span>
                                            
                                            <?php echo $this->Html->link('<i class="fa fa-pencil"></i>', array("controller" => "keywords", "action" => 'editjobs',$announcement['Keyword']['slug']), array('escape' => false, 'class' => "btn btn-warning btn-xs", 'title' => 'Edit')); ?>
                                            <?php echo $this->Html->link('<i class="fa fa-trash-o "></i>', array('controller' => 'keywords', 'action' => 'deletejobs',$announcement['Keyword']['slug']), array('update' => 'deleted' . $announcement['Keyword']['id'], 'indicator' => 'loaderID', 'class' => 'btn btn-primary btn-xs', 'confirm' => 'Are you sure you want to Delete ?', 'escape' => false, 'title' => 'Delete')); ?>
            ...
            <div id="actdiv" class="outside">
                <div class="block-footer mogi">
                    ...
                    <?php echo $this->Ajax->submit("Activate", array('div' => false, 'url' => array('controller' => 'keywords', 'action' => 'jobs'), 'update' => 'listID', 'indicator' => 'loaderID', 'before' => "setAction('activate');", 'confirm' => "Are you sure you want to Activate ?", 'condition' => "isAnySelect(this.form)", "complete" => "showMessage('activated');", 'class' => 'btn btn-success btn-cons')); 
                        echo $this->Ajax->submit("Deactivate", array('div' => false, 'url' => array('controller' => 'keywords', 'action' => 'jobs'), 'update' => 'listID', 'indicator' => 'loaderID', 'before' => "setAction('deactivate');", 'confirm' => "Are you sure you want to Deactivate ?", 'condition' => "isAnySelect(this.form)", "complete" => "showMessage('deactivated');", 'class' => 'btn btn-success btn-cons')); 
                     echo $this->Ajax->submit("Delete", array('div' => false, 'url' => array('controller' => 'keywords', 'action' => 'jobs'), 'update' => 'listID', 'indicator' => 'loaderID', 'before' => "setAction('delete');", 'confirm' => "Are you sure you want to Delete ?", 'condition' => "isAnySelect(this.form)", "complete" => "showMessage('deleted');", 'class' => 'btn btn-success btn-cons')); ?> 
                </div>
            </div>
            <div id="pagingLinks" align="right">
                    <?php __("Showing Page"); ?>
