                      ...
                      //  echo '<pre>';print_r($users);exit;
                        if (!empty($users)) {
                            foreach ($users as $user) {
                                ...
                                ////////////////send job alert mail to jobseekers
                               ...
                               // $location = $jobDetail['Job']['job_city'];
                                ...
                                $city = ClassRegistry::init('City')->field('city_name', array('City.id' => $jobDetail['Job']['city_id']));
                            $state = ClassRegistry::init('State')->field('state_name', array('State.id' => $jobDetail['Job']['state_id']));
